...
from api.utilities.cookie_store import get_private_api_cookie, update_private_api_cookie
from tests.helpers import cookie_helper


class TestCookieStore(TestCase):
    @patch("api.utilities.cookie_store.__COOKIES_FILE", cookie_helper.MOCK_COOKIES_PATH)
