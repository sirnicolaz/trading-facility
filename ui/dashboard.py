...
class Dashboard(npyscreen.NPSAppManaged):
    ...
    def __init__(self, data_producer, gains_worker_pipe, reference_currency, *args, **kwargs):
    ...
    def onStart(self):
        self.addForm('MAIN', CoinsStatus , reference_currency=self.reference_currency, data_producer=self.data_producer)
